...
const keyCityId = 'objectId';
const keyCityName = 'name';
const keyCityCoordinates = 'coordinates';

const keyNeighborhoodTable = 'Neighborhoods';
const keyNeighborhoodId = 'objectId';
